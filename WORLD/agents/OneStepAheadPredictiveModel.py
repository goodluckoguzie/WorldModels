    ...
    def train(self):
        ...
        for i in range(self.num_episodes):
            ...
            while not done: 
                ...
                if len(self.experience_replay) > (self.batch_size * self.batch_size):
                    self.update()
...
if __name__ == "__main__":
    ...
    input_layer_size = 84 #env.observation_space["goal"].shape[0] + env.observation_space["humans"].shape[0] + env.observation_space["laptops"].shape[0] + env.observation_space["tables"].shape[0] + env.observation_space["plants"].shape[0]+hiddens
