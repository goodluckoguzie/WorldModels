...
import argparse
import numpy as np
from UTILITY.early_stopping_for_rnn_dqn import  EarlyStopping
...
train_data = torch.load('./Data/saved_dqn_rollout_train.pt')
val_data = torch.load('./Data/saved_dqn_rollout_validation.pt')
...
def train_model(model, batch_size, patience, n_epochs):
    ...
    model.load_state_dict(torch.load('./MODEL/rnn_dqn_model.pt'))
