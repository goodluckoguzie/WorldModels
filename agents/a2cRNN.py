...
class A2CAgent:
    def __init__(self, env:gym.Env, config:str, **kwargs):
        ...
        # self.vae.eval()
        # print('Loaded vae ckpt {}'.format(self.ckpt))       
        self.ckpt  = sorted(glob.glob(os.path.join(self.ckpt_dir, 'DQN_RobotFrameDatasetsTimestep1window_16', '004DQN_trainedRobotframe.pth.tar')))[-1] #RobotFrameDatasetsTimestep05window_16
