...
class DuelingDQNAgent:
    ...
    def preprocess_observation_compressed(self,obs):
        """
    ...
    def train(self):
        ...
        for i in range(self.num_episodes):
            ...
            # current_obs = self.preprocess_observation_compressed(current_obs)
            done = False
            ...
            while not done: 
                ...
                # next_obs = self.preprocess_observation_compressed(next_obs)
    ...
    def eval(self, num_episodes, path=None):
        ...
        for i in range(num_episodes):
            ...
            while not done:
                ...
                new_state = self.preprocess_observation_compressed(new_state)
