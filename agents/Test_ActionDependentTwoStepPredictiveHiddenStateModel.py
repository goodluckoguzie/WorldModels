...
class DuelingDQNAgent:
    ...
    ########################################################################################
     ...
     # Calculate averages and store them in a dictionary
        ...
        df.to_csv('RESULTS/ADTSPHSMduelingDQNAveragesresults.csv', index=False)

        # Save the DataFrame to a JSON file
        df.to_json('RESULTS/ADTSPHSMduelingDQNAveragesresults.json', orient='records')
        ...
        data.to_csv('RESULTS/ADTSPHSMduelingDQNresults.csv', index=False)

        # Save DataFrame to json
        data.to_json('RESULTS/ADTSPHSMduelingDQNresults.json', orient='records')

        # Plot results
        plt.figure(figsize=(10, 6))
        plt.suptitle('Line Plots for Episode Metrics - Action Dependent Two Step Predictive Hidden State Model', fontsize=10)
